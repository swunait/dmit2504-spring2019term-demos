...
public class BaseActor extends Group {
    ...
    // To store animation and related data
    private Animation<TextureRegion> animation;
    private float elapsedTime;
    private boolean animationPaused;

    // To track velocity data
    private Vector2 velocityVec;

    // To track acceleration data
    ...
    public BaseActor(float x, float y, Stage s) {
        ...
        // initialize the variables used for animation
        animation = null;
        elapsedTime = 0;
        ...
        // initialize the acceleration and deceleration speed
        maxSpeed = 1000;
        deceleration = 0;
    ...
    public void setSpeed(float speed) {
        // if length is zero, them assume motion angle is zero degrees
    ...
    // Align camera when the size of the game world is larger than the screen size
